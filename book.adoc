...
.Aleph-Bet
// {{{
[.heb,width="60%",options="header",cols="^,^,^,^,^,^"]
|===
...
is today in most Middle Eastern traditions of reading. It is, however,
pronounced as "v" in Modern Hebrew.
...
^^^^^^^^^
// {{{
Gutturals are a special class of consonants which are pronounced in
various parts of the throat. The Hebrew gutturals are ח, ה, א, and ע.
The letter ר, while not technically a guttural in linguistic terms,
shares an important feature with the gutturals: It cannot be doubled.
This will be discussed more fully in the section on the Masoretic
pointing, as well as several other unique properties of the letter.
...
most cases and many have other side effects.

* _heʾ_, ה, is the same as the English letter "h." It is a partial
opening of the glottis so the air creates a rough sound as it passes.
...
https://en.wikipedia.org/wiki/Voiceless_uvular_fricative[voiceless
uvular fricative]. This is similar to the sound one makes when
...
vibrate the vocal chords, so it is a
https://en.wikipedia.org/wiki/Voiced_pharyngeal_fricative[voiced
pharyngeal fricative]. There is no clear way to describe this sound, but
some English speakers make it when imitating the pirate battle cry,
"arr!" with a pinched feeling in the throat. Luckily, this sound is not
used in European traditions of pronunciation, and is less common in
modern Israeli Hebrew, though again, it is favored for formal media.
Most speakers today simply pronounce it as a glottal stop, like ʾālef.
Unlike alef, it does not become silent at the end of a syllable.
// }}}
...
* _waw_, [heb]#ו#, sometimes indicates an *û* or an *ô* vowel.
* _yôḏ_, [heb]#י#, sometimes indicates an *î* or an *ê* vowel.
* _heʾ_, [heb]#ה#, is only used to mark vowels at the end of words.  It most 
...
consonant if it has a dot in the middle.  This dot is called a
_mappiq_: הּ
...
text. These are referred to as _niqqud_ ([heb]#נִקֻּד#; lit. "pointing"). Though
...
.Full vowels
// {{{
[.heb,width="50%",options="header",cols="^,^,^,^"]
|===
...
- [heb]#מֶלֶךְ# = King
- [heb]#מַלְכָּה# = Queen
- [heb]#מַמְלָכָה# = kingdom
- [heb]#מַלְכוּת# = reign (noun)
- [heb]#מְלוּכָה# = monarchy
- [heb]#מְלֹךְ# = to reign
- [heb]#מָלַכְתִּי# = I reigned
...
- *Feminine Singular* words often end in [heb]#אאאָה#, אאאֶת or sometimes אאאִית.
...
//{{{
.Independent personal pronouns
[width="40%",options="header",cols="<,^,^"]
|===
|   |Singular  | Plural
s|1c|[rtl]#אֲנִ֫י (אָנֹכִ֫י)#|[rtl]#אֲנַ֫חְנוּ (אֲנוּ)#
s|2m|אַתָּ֫ה       |אַתֶּ֫ם
s|2f|אַ֫תְּ        |[rtl]#אַתֵּנָה (אַתֶּ֫ן)#
s|3m|ה֫וּא       |[rtl]#הֵ֫ם (הֵ֫מָּה)#
s|3f|הִ֫יא       |[rtl]#הֵ֫נָּה (הֵ֫ן)#
|===
...
Demonstratives are a feature of many languages that add an increased
level of specificity. In Hebrew and English, the demonstratives function
both as independant pronouns and as attributive adjectives (I classify
both of these uses under "demonstrative pronouns," but some grammars
classify them differently). Likewise, in both English and Hebrew
// }}}
...
s| f |[rtl]#קֹטֶ֫לֶת (קֹֽטְלָ֫ה)#| קֹֽטְלֹ֫ת
|===
